...
namespace Chronos.Api.Migrations
{
    ...
    [Migration("20250819193427_Adding_DiaryEntry")]
    partial class Adding_DiaryEntry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chronos.Api.Entities.DiaryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Chronos.Api.Entities.Prediction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Chronos.Api.Entities.PredictionSale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Chronos.Api.Entities.DiaryEntry", b =>
                {
                    ...
                    b.HasOne("Chronos.Api.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Chronos.Api.Entities.PredictionSale", b =>
                {
                    b.HasOne("Chronos.Api.Entities.Prediction", null)
                        .WithMany("Sales")
